...
export class InventoryArticlesController {
    constructor(private readonly inventoryArticlesService: InventoryArticlesService) {
    }
    ...
    async createInventoryArticles(@Body() inventoryArticle: CreateArticlesDto) {
        return this.inventoryArticlesService.createInventoryArticles(inventoryArticle);
    }
